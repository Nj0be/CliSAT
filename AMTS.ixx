...
export inline std::pair<custom_bitset, bool> AMTS(const custom_graph& g, const uint64_t k, const uint64_t L, const uint64_t Iter_max, const std::chrono::time_point<std::chrono::steady_clock> max_time) {
